"""Policy Analysis Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Policy analysis agent that reviews corporate policies for legal compliance, identifies policy gaps, compares against industry standards, recommends updates, and tracks policy lifecycle.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
