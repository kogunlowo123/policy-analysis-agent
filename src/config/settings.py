"""Application configuration for Policy Analysis Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="policy-analysis-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/policy_analysis_agent",
    ...
    opensearch_index: str = Field(default="policy_analysis_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="policy-analysis-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="policy-analysis-agent", description="A2A agent ID")
